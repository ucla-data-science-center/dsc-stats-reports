...
**Workshop attendee**
One participant registration record in a LibInsight event export. A single person attending three workshops is counted three times — this reflects total attendee-events, not unique individuals.
...
- **Source code**: [github.com/UCLALibrary/dsc-stats-reports](https://github.com/ucla-data-science-center/dsc-stats-reports) *(update to actual URL)*
- **Issues / contributions**: Open a pull request or issue in the repository
- **General inquiries**: [dsc@library.ucla.edu](mailto:dsc@library.ucla.edu) *(confirm address)*
