...
| AWS usage trends | Monthly (Cost Explorer API pull) |
...
|---|---|---|
| **LibInsight** (Springshare) | DSC scheduled consultations | `data/processed/consultations/` |
| **Consolidated instruction sources** | Workshop attendance, including UC GIS Week and Love Data Week | `data/raw/instruction/` |
...
| **AWS Cost Explorer API** | Monthly cloud usage share by service/application (relative, not dollar amounts) | `data/raw/infrastructure/AWS_Costs/` |
...
A broader reporting group assigned only when a record has validated UCLA affiliation and a mapped standardized department. Parents may be a College division, professional school, the Library, UCLA Health, an institute, or an administrative group. Missing and unresolved departments remain unknown.
...
- **AWS billing lag**: Cost Explorer data for the most recent 1–2 months is an estimate; the relative-share figures may shift after the billing period closes.
...
For the institutional history behind these numbers, see [UCLA's Social Science Data Archive: an institutional history](https://ucla-data-science-center.github.io/ssda-dsc-history/history.html), 1961-present.
