# ================================================
# Standardize Department Names Map
# ================================================
# This map is used to standardize department names.
# Any department name (in lower-case) that does not have a mapping here
# will be converted to NA.
#
# Usage example:
#   standardized <- standardize_map[["biology"]]  # returns "Biology"
