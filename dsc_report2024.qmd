...
# Source the R script
#source("src/etl/data_cleaning.R")
source("src/etl/data_cleaning.R")

# Load the cleaned and merged data
dsc_consult <- readRDS("data/processed/consultations/dsc_consult_merged.rds")
# Load the standardized data
load("data/processed/consultations/standardized_data.rda")
load("data/processed/instruction/ucla_workshops.rda")
dataverse <- read_csv('data/raw/infrastructure/datasets_files_published_monthly.csv')
```
...
combined_tokens <- readRDS("data/processed/consultations/combined_tokens.rds")
