...
try:
    ...
    df_dv['month_downloads'] = df_dv['downloads'].diff().fillna(0)
    ...
    ax2 = ax1.twinx()
    ax2.plot(df_recent['date'], df_recent['month_new_files'], color='#FFD100', marker='o', label='New Files')
    ax2.set_ylabel('New Files', color='#8B6F00')
    ax1.set_title('Dataverse Monthly Activity (Datasets & Files)')
    
    # Chart 2: Downloads
    ax3.bar(df_recent['date'], df_recent['month_downloads'], color='#2ca02c', alpha=0.7, width=20, label='Downloads')
    ax3.set_ylabel('Monthly Downloads', color='#2ca02c')
    ax3.set_title('Dataverse Monthly Downloads')
