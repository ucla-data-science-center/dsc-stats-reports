...
# --------------------------------
source("src/etl/standardize_map.R")  # Ensure this file is in the working directory
...
dsc_workshops <- read_csv('data/raw/instruction/dsc_workshops.csv', na = c("N/A", "", "NA")) 
...
dsc_calendly <- read_csv('data/raw/consultations/libinsights-full21-24-dataframe.csv')

# DataSquad Sign-in Data
dsquad_sign_in <- read_csv('data/raw/consultations/datasquad-sign-in.csv')

# Trello Data: Data for projects from Trello board
dsquad_trello <- read_csv('data/raw/consultations/ucla-datasquad-projects-trello.csv')
...
saveRDS(dsc_consult, "data/processed/consultations/dsc_consult_merged.rds")
...
saveRDS(dsc_consult, "data/processed/consultations/dsc_consult_standardized.rds")
